...
async function loadModel() {
    ...
    try {
        const gltf2 = await loader.loadAsync('https://cpen320.s3.us-east-1.amazonaws.com/stylized_palm_tree.glb');
        model2 = gltf2.scene;
        scene.add(model2)
        model2.scale.set(1, 1, 1); // Scale the model down to half its original size
        gltf2.scene.position.set(0,-10,0);
...
function animate() {
    if (model2) {
            ...
            model2.position.z = Math.sin(time) * 10;
